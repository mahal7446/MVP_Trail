...
export const indianStates: StateData[] = [
    ...
    },
    {
        ...
        districts: [
            ...
            "Mon", "Noklak", "Peren", "Phek", "Tuensang",
            "Wokha", "Zunheboto"
        ]
    },
    {
...
// Flatten all districts with their states for easy searching
export const allDistricts: District[] = indianStates.flatMap(state =>
...
export const formatLocation = (district: District): string => {
