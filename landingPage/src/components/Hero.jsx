      ...
      <div className="container mx-auto px-6 w-full relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="px-8 py-3 bg-agri-green text-agri-button-dark font-semibold rounded-full hover:bg-agri-green-light transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
              Getting Started
            </button>
