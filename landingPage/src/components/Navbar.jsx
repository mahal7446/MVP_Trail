  ...
  return (
    <nav className="fixed w-full top-0 z-50 bg-transparent backdrop-blur-md bg-opacity-30">
      <div className="container mx-auto px-6 h-[72px] flex items-center justify-between">
        ...
        {/* CTA Button */}
        <button className="bg-white text-agri-button-dark font-semibold px-6 py-2.5 rounded-full hover:bg-agri-green-light transition-all duration-300 shadow-lg">
          Get Started
        </button>
      </div>
    </nav>
