    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-agri-green from-opacity-5 to-transparent p-12 md:p-16 rounded-2xl border border-agri-green-light border-opacity-20">
          ...
          <button className="px-10 py-4 bg-agri-green text-agri-button-dark font-semibold text-lg rounded-full hover:bg-agri-green-light transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
            Get Started 
          </button>
        </div>
      </div>
